...
const isArticle = (dynamicPageItem) => {  
  return dynamicPageItem && dynamicPageItem.properties.definitionName === 'DocArticle'
}
...
const WithSidebarNavTemplate = (props) => {  
  ...
  return (
    ...
    >
      ...
      <div id="ScrollContainer" className="flex-grow overflow-y-auto border-l border-gray-200">
      ...
      {hasArticle &&
      <div>
        <div className="hidden xl:block sticky top-[128px] w-60 flex-none pt-4">
          <ArticleNav dynamicPageItem={props.dynamicPageItem} sitemapNode={props.sitemapNode} />
        </div>
      </div>
      }

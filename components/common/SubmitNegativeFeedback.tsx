...
interface SubmitNegativeFeedbackProps {
  url: string;
  title: string;
  setNegativeFeedbackSubmitted: (submitted: boolean) => void;
  setNegativeFeedbackClicked: (clicked: boolean) => void;
}
